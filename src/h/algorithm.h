...
namespace ctgl {
    ...
    namespace detail {
        ...
        constexpr auto shortest(ADL, G, S, T, List<N, Ns...>) noexcept {
            constexpr auto skip = shortest(ADL{}, G{}, S{}, T{}, List<Ns...>{});
            constexpr auto branch = shortest(ADL{}, G{}, N{}, T{}, decltype(graph::adjacent(G{}, N{})){});
            ...
            if constexpr (list::empty(skip) && list::empty(branch)) {
                ...
                // Node |T| is transitively connected to Node |S| through a Node in |Ns|.
                return skip;
        ...
        constexpr auto shortest(ADL, G, S, S, List<Ns...>) noexcept {
            return List<S>{};
        }
        ...
        constexpr auto shortest(ADL, G, S, T, List<>) noexcept {
            return List<>{};
        }
    }
    ...
    constexpr auto shortest(G, S, T) noexcept {
        ...
        if constexpr (!feasible) {
            ...
            return detail::shortest(detail::ADL{}, G{}, S{}, T{}, decltype(graph::adjacent(G{}, S{})){});
        }
    }
    ...
    constexpr int distance(G, S, T) noexcept {
        constexpr auto size = list::size(ctgl::shortest(G{}, S{}, T{}));
