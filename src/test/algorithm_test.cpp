...
TEST(AlgorithmTest, Shortest) {
    // Empty
    EXPECT_EQ(shortest(Empty{}, N1{}, N1{}), DNE);
    EXPECT_EQ(shortest(Empty{}, N1{}, N2{}), DNE);

    // Island
    EXPECT_EQ(shortest(Island{}, N1{}, N1{}), Path<>{});
    EXPECT_EQ(shortest(Island{}, N1{}, N2{}), DNE);
    EXPECT_EQ(shortest(Island{}, N2{}, N1{}), DNE);
    ...
    EXPECT_EQ(shortest(Arrow{}, N2{}, N1{}), DNE);
    ...
    EXPECT_EQ(shortest(Pan{}, N2{}, N1{}), DNE);
    EXPECT_EQ(shortest(Pan{}, N2{}, N2{}), Path<>{});
    EXPECT_EQ(shortest(Pan{}, N2{}, N3{}), Path<E23>{});
    EXPECT_EQ(shortest(Pan{}, N2{}, N4{}), DNE);

    EXPECT_EQ(shortest(Pan{}, N3{}, N1{}), DNE);
    EXPECT_EQ(shortest(Pan{}, N3{}, N2{}), DNE);
    EXPECT_EQ(shortest(Pan{}, N3{}, N3{}), Path<>{});
    EXPECT_EQ(shortest(Pan{}, N3{}, N4{}), DNE);

    EXPECT_EQ(shortest(Pan{}, N4{}, N1{}), DNE);
    ...
    EXPECT_EQ(shortest(Bow{}, N6{}, N5{}), DNE);
    EXPECT_EQ(shortest(Bow{}, N6{}, N7{}), DNE);
    EXPECT_EQ(shortest(Bow{}, N7{}, N5{}), DNE);
